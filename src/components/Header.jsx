...
function Header() {
  ...
  return (
    <>
    <header className="fixed inset-x-0 top-0 z-50 h-[65px] bg-cream/80 backdrop-blur-sm max-w-[1600px] mx-auto">
      ...
      <div
        className={`fixed inset-x-0 top-[65px] bottom-0 z-40 overflow-y-auto bg-cream transition-all duration-300 lg:hidden max-w-[1600px] mx-auto ${
